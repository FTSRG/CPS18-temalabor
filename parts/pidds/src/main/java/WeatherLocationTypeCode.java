...
public class  WeatherLocationTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("WeatherLocation",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,LocationTypeTypeCode.VALUE, sm);        
        return tc;
    }
}
