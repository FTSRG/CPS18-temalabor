...
public class  ExtendedWeatherDataTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("weather::ExtendedWeather::ExtendedWeatherData",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,weather.MinimalWeather.MinimalWeatherDataTypeCode.VALUE, sm);        
        return tc;
    }
}
