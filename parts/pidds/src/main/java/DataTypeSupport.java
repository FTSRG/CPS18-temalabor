...
public class DataTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=LocationTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment +=SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += LocationTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment +=CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment) ;
        ...
        Object sample) 
    {
        ...
        currentAlignment += LocationTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.location);

        currentAlignment += SensorMetaTypeTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            LocationTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.location, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            SensorMetaTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.sensorMeta, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.location = (LocationType)LocationTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.location, src, false, true, endpoint_plugin_qos);     
                typedDst.sensorMeta = (SensorMetaType)SensorMetaTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.sensorMeta, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            LocationTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            SensorMetaTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
