...
public class MetadataTypeSupport extends TypeSupportImpl {
    ...
    */
        ...
        Object sample) 
    {
        ...
        currentAlignment += metadata.Source.SourceDataTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            metadata.Source.SourceDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            metadata.Source.SourceDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
