...
public class LocationTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "abstract::DataModel::LocationType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LocationTypeTypeSupport _singleton
    = new LocationTypeTypeSupport();
    ...
    */
    public static LocationTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static LocationTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LocationTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LocationType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LocationType typedDst = (LocationType) destination;
        LocationType typedSrc = (LocationType) source;
        ...
        Object sample) 
    {
        ...
        LocationType typedSrc = (LocationType) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.locationName );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.locationName,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LocationType typedDst = (LocationType) dst;
            typedDst.clear();      
            try{
                typedDst.locationName = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LocationType typedDst = (LocationType) sample;
    ...
    int mask) {
        return new LocationTypeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LocationTypeDataReader(native_reader, listener, mask, this);   
    ...
    protected LocationTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LocationTypeTypeCode.VALUE,LocationType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LocationTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LocationTypeTypeCode.VALUE,LocationType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
