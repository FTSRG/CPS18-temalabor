...
/**
* A sequence of SensorMetaType instances.
*/
public final class SensorMetaTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SensorMetaTypeSeq() {
        super(SensorMetaType.class);
    }

    public SensorMetaTypeSeq (int initialMaximum) {
        super(SensorMetaType.class, initialMaximum);
    }

    public SensorMetaTypeSeq (Collection elements) {
        super(SensorMetaType.class, elements);
    }

    public  SensorMetaType get(int index) { 
        return (SensorMetaType) super.get(index); 
    }
