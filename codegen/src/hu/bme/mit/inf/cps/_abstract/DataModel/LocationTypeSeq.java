...
/**
* A sequence of LocationType instances.
*/
public final class LocationTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LocationTypeSeq() {
        super(LocationType.class);
    }

    public LocationTypeSeq (int initialMaximum) {
        super(LocationType.class, initialMaximum);
    }

    public LocationTypeSeq (Collection elements) {
        super(LocationType.class, elements);
    }

    public  LocationType get(int index) { 
        return (LocationType) super.get(index); 
    }
