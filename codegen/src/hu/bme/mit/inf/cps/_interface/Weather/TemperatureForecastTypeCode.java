...
public class  TemperatureForecastTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("interface::Weather::TemperatureForecast",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeCode.VALUE, sm);        
        return tc;
    }
}
