...
public class TemperatureForecastTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "interface::Weather::TemperatureForecast";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TemperatureForecastTypeSupport _singleton
    = new TemperatureForecastTypeSupport();
    ...
    */
    public static TemperatureForecastTypeSupport get_instance() {
        return _singleton;
    }

    public static TemperatureForecastTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TemperatureForecastTypeCode.VALUE;
    }

    public Object create_data() {
        return TemperatureForecast.create();
    }
    ...
    * <code>this</code> is not a <code>TemperatureForecast</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TemperatureForecast typedDst = (TemperatureForecast) destination;
        TemperatureForecast typedSrc = (TemperatureForecast) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        TemperatureForecast typedSrc = (TemperatureForecast) sample;
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data, false, encapsulation_id, currentAlignment, sample);

        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.forecastTime );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            dst.writeString(typedSrc.forecastTime,255);

            dst.writeDouble(typedSrc.minimum);

            dst.writeDouble(typedSrc.maximum);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TemperatureForecast typedDst = (TemperatureForecast) dst;
            typedDst.clear();      
            hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.forecastTime = src.readString(255);
                typedDst.minimum = src.readDouble();
                typedDst.maximum = src.readDouble();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.inf.cps._abstract.Weather.WeatherTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            src.skipString();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TemperatureForecast typedDst = (TemperatureForecast) sample;
    ...
    int mask) {
        return new TemperatureForecastDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TemperatureForecastDataReader(native_reader, listener, mask, this);   
    ...
    protected TemperatureForecastTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TemperatureForecastTypeCode.VALUE,TemperatureForecast.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TemperatureForecastTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TemperatureForecastTypeCode.VALUE,TemperatureForecast.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
