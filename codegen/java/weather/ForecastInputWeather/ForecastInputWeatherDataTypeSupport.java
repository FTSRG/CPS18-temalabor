...
public class ForecastInputWeatherDataTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
        ...
        currentAlignment +=weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            dst.writeDouble(typedSrc.SeaLevelPressure);

            dst.writeString(typedSrc.Phenomena,80);

            weather.Cloud.CloudDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cloud, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.SeaLevelPressure = src.readDouble();
                typedDst.Phenomena = src.readString(80);
                typedDst.cloud = (weather.Cloud.CloudData)weather.Cloud.CloudDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cloud, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            src.skipDouble();

            src.skipString();

            weather.Cloud.CloudDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
