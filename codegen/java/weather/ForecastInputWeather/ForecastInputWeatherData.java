...
public class ForecastInputWeatherData  extends weather.ExtendedWeather.ExtendedWeatherData implements Copyable, Serializable{

    public double SeaLevelPressure= 0;
    public String Phenomena=  "" ; /* maximum length = (80) */
    public weather.Cloud.CloudData cloud = (weather.Cloud.CloudData)weather.Cloud.CloudData.create();
    ...
    */
    public Object copy_from(Object src) {
        ...
        typedDst.cloud = (weather.Cloud.CloudData) typedDst.cloud.copy_from(typedSrc.cloud);
