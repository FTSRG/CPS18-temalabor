...
public class CloudDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "weather::Cloud::CloudData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CloudDataTypeSupport _singleton
    = new CloudDataTypeSupport();
    ...
    */
    public static CloudDataTypeSupport get_instance() {
        return _singleton;
    }

    public static CloudDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CloudDataTypeCode.VALUE;
    }

    public Object create_data() {
        return CloudData.create();
    }
    ...
    * <code>this</code> is not a <code>CloudData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CloudData typedDst = (CloudData) destination;
        CloudData typedSrc = (CloudData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (25)+1);
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        CloudData typedSrc = (CloudData) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.description,25);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CloudData typedDst = (CloudData) dst;
            typedDst.clear();      
            try{
                typedDst.Value = src.readShort();
                typedDst.description = src.readString(25);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CloudData typedDst = (CloudData) sample;
    ...
    int mask) {
        return new CloudDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CloudDataDataReader(native_reader, listener, mask, this);   
    ...
    protected CloudDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CloudDataTypeCode.VALUE,CloudData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CloudDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CloudDataTypeCode.VALUE,CloudData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
