...
/**
* A sequence of CloudData instances.
*/
public final class CloudDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CloudDataSeq() {
        super(CloudData.class);
    }

    public CloudDataSeq (int initialMaximum) {
        super(CloudData.class, initialMaximum);
    }

    public CloudDataSeq (Collection elements) {
        super(CloudData.class, elements);
    }

    public  CloudData get(int index) { 
        return (CloudData) super.get(index); 
    }
