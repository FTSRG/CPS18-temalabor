...
public class ForecastInputWeatherDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "weather::ForecastInputWeather::ForecastInputWeatherData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ForecastInputWeatherDataTypeSupport _singleton
    = new ForecastInputWeatherDataTypeSupport();
    ...
    */
    public static ForecastInputWeatherDataTypeSupport get_instance() {
        return _singleton;
    }

    public static ForecastInputWeatherDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ForecastInputWeatherDataTypeCode.VALUE;
    }

    public Object create_data() {
        return ForecastInputWeatherData.create();
    }
    ...
    public Object create_key() {
        return new ForecastInputWeatherData();
    }
    ...
    public Class get_type() {
        return ForecastInputWeatherData.class;
    }
    ...
    * <code>this</code> is not a <code>ForecastInputWeatherData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ForecastInputWeatherData typedDst = (ForecastInputWeatherData) destination;
        ForecastInputWeatherData typedSrc = (ForecastInputWeatherData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);

        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (80)+1);
        currentAlignment +=hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        ForecastInputWeatherData typedSrc = (ForecastInputWeatherData) sample;
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.Phenomena );

        currentAlignment += hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cloud);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            dst.writeDouble(typedSrc.SeaLevelPressure);

            dst.writeString(typedSrc.Phenomena,80);

            hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cloud, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ForecastInputWeatherData typedDst = (ForecastInputWeatherData) dst;
            typedDst.clear();      
            hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.SeaLevelPressure = src.readDouble();
                typedDst.Phenomena = src.readString(80);
                typedDst.cloud = (hu.bme.mit.inf.weather.weather.Cloud.CloudData)hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cloud, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            src.skipDouble();

            src.skipString();

            hu.bme.mit.inf.weather.weather.Cloud.CloudDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ForecastInputWeatherData typedDst = (ForecastInputWeatherData) sample;
    ...
    int mask) {
        return new ForecastInputWeatherDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ForecastInputWeatherDataDataReader(native_reader, listener, mask, this);   
    ...
    protected ForecastInputWeatherDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ForecastInputWeatherDataTypeCode.VALUE,ForecastInputWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ForecastInputWeatherDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ForecastInputWeatherDataTypeCode.VALUE,ForecastInputWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
