...
public class  AirportWeatherDataTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("weather::AirportWeather::AirportWeatherData",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,hu.bme.mit.inf.weather.weather.ExtendedWeather.ExtendedWeatherDataTypeCode.VALUE, sm);        
        return tc;
    }
}
