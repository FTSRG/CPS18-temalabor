...
public class ExtendedWeatherDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "weather::ExtendedWeather::ExtendedWeatherData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ExtendedWeatherDataTypeSupport _singleton
    = new ExtendedWeatherDataTypeSupport();
    ...
    */
    public static ExtendedWeatherDataTypeSupport get_instance() {
        return _singleton;
    }

    public static ExtendedWeatherDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ExtendedWeatherDataTypeCode.VALUE;
    }

    public Object create_data() {
        return ExtendedWeatherData.create();
    }
    ...
    public Object create_key() {
        return new ExtendedWeatherData();
    }
    ...
    public Class get_type() {
        return ExtendedWeatherData.class;
    }
    ...
    * <code>this</code> is not a <code>ExtendedWeatherData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ExtendedWeatherData typedDst = (ExtendedWeatherData) destination;
        ExtendedWeatherData typedSrc = (ExtendedWeatherData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        ...
        Object sample) 
    {
        ...
        ExtendedWeatherData typedSrc = (ExtendedWeatherData) sample;
        ...
        currentAlignment += hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            dst.writeDouble(typedSrc.Pressure);

            dst.writeDouble(typedSrc.WindDirection);

            dst.writeDouble(typedSrc.WindSpeed);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ExtendedWeatherData typedDst = (ExtendedWeatherData) dst;
            typedDst.clear();      
            hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.Pressure = src.readDouble();
                typedDst.WindDirection = src.readDouble();
                typedDst.WindSpeed = src.readDouble();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.inf.weather.weather.MinimalWeather.MinimalWeatherDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            src.skipDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ExtendedWeatherData typedDst = (ExtendedWeatherData) sample;
    ...
    int mask) {
        return new ExtendedWeatherDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ExtendedWeatherDataDataReader(native_reader, listener, mask, this);   
    ...
    protected ExtendedWeatherDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ExtendedWeatherDataTypeCode.VALUE,ExtendedWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ExtendedWeatherDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ExtendedWeatherDataTypeCode.VALUE,ExtendedWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
