...
public class AirportWeatherDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "weather::AirportWeather::AirportWeatherData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AirportWeatherDataTypeSupport _singleton
    = new AirportWeatherDataTypeSupport();
    ...
    */
    public static AirportWeatherDataTypeSupport get_instance() {
        return _singleton;
    }

    public static AirportWeatherDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AirportWeatherDataTypeCode.VALUE;
    }

    public Object create_data() {
        return AirportWeatherData.create();
    }
    ...
    public Class get_type() {
        return AirportWeatherData.class;
    }
    ...
    * <code>this</code> is not a <code>AirportWeatherData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AirportWeatherData typedDst = (AirportWeatherData) destination;
        AirportWeatherData typedSrc = (AirportWeatherData) source;
        ...
        Object sample) 
    {
        ...
        AirportWeatherData typedSrc = (AirportWeatherData) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WindGust);

            dst.writeDouble(typedSrc.WindDirChange);

            dst.writeDouble(typedSrc.WindDirChange1);

            dst.writeDouble(typedSrc.DewPoint);

            dst.writeDouble(typedSrc.ViewDistance);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AirportWeatherData typedDst = (AirportWeatherData) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.WindGust = src.readDouble();
                typedDst.WindDirChange = src.readDouble();
                typedDst.WindDirChange1 = src.readDouble();
                typedDst.DewPoint = src.readDouble();
                typedDst.ViewDistance = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AirportWeatherData typedDst = (AirportWeatherData) sample;
    ...
    int mask) {
        return new AirportWeatherDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AirportWeatherDataDataReader(native_reader, listener, mask, this);   
    ...
    protected AirportWeatherDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AirportWeatherDataTypeCode.VALUE,AirportWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AirportWeatherDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AirportWeatherDataTypeCode.VALUE,AirportWeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
