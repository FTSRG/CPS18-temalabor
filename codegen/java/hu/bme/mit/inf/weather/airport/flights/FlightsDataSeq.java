...
/**
* A sequence of FlightsData instances.
*/
public final class FlightsDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FlightsDataSeq() {
        super(FlightsData.class);
    }

    public FlightsDataSeq (int initialMaximum) {
        super(FlightsData.class, initialMaximum);
    }

    public FlightsDataSeq (Collection elements) {
        super(FlightsData.class, elements);
    }

    public  FlightsData get(int index) { 
        return (FlightsData) super.get(index); 
    }
