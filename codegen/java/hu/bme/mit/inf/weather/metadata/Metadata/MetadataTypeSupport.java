...
public class MetadataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "metadata::Metadata::Metadata";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MetadataTypeSupport _singleton
    = new MetadataTypeSupport();
    ...
    */
    public static MetadataTypeSupport get_instance() {
        return _singleton;
    }

    public static MetadataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MetadataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Metadata</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Metadata typedDst = (Metadata) destination;
        Metadata typedSrc = (Metadata) source;
        ...
        Object sample) 
    {
        ...
        Metadata typedSrc = (Metadata) sample;
        ...
        currentAlignment += hu.bme.mit.inf.weather.metadata.Source.SourceDataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.source);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.weather.metadata.Source.SourceDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.inf.weather.metadata.Source.SourceDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Metadata typedDst = (Metadata) sample;
    ...
    int mask) {
        return new MetadataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MetadataDataReader(native_reader, listener, mask, this);   
    ...
    protected MetadataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MetadataTypeCode.VALUE,Metadata.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MetadataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MetadataTypeCode.VALUE,Metadata.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
