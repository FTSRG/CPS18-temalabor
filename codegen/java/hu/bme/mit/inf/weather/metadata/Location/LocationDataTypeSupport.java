...
public class LocationDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "metadata::Location::LocationData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LocationDataTypeSupport _singleton
    = new LocationDataTypeSupport();
    ...
    */
    public static LocationDataTypeSupport get_instance() {
        return _singleton;
    }

    public static LocationDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LocationDataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LocationData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LocationData typedDst = (LocationData) destination;
        LocationData typedSrc = (LocationData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (60)+1);
        ...
        Object sample) 
    {
        ...
        LocationData typedSrc = (LocationData) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.name,60);

            dst.writeDouble(typedSrc.latitude);

            dst.writeDouble(typedSrc.longitude);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LocationData typedDst = (LocationData) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(60);
                typedDst.latitude = src.readDouble();
                typedDst.longitude = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LocationData typedDst = (LocationData) sample;
    ...
    int mask) {
        return new LocationDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LocationDataDataReader(native_reader, listener, mask, this);   
    ...
    protected LocationDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LocationDataTypeCode.VALUE,LocationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LocationDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LocationDataTypeCode.VALUE,LocationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
