...
/**
* A sequence of LocationData instances.
*/
public final class LocationDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LocationDataSeq() {
        super(LocationData.class);
    }

    public LocationDataSeq (int initialMaximum) {
        super(LocationData.class, initialMaximum);
    }

    public LocationDataSeq (Collection elements) {
        super(LocationData.class, elements);
    }

    public  LocationData get(int index) { 
        return (LocationData) super.get(index); 
    }
