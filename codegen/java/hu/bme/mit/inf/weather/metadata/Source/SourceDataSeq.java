...
/**
* A sequence of SourceData instances.
*/
public final class SourceDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SourceDataSeq() {
        super(SourceData.class);
    }

    public SourceDataSeq (int initialMaximum) {
        super(SourceData.class, initialMaximum);
    }

    public SourceDataSeq (Collection elements) {
        super(SourceData.class, elements);
    }

    public  SourceData get(int index) { 
        return (SourceData) super.get(index); 
    }
