...
public class SensorMetaTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "abstract::DataModel::SensorMetaType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SensorMetaTypeTypeSupport _singleton
    = new SensorMetaTypeTypeSupport();
    ...
    */
    public static SensorMetaTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static SensorMetaTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SensorMetaTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return SensorMetaType.create();
    }
    ...
    * <code>this</code> is not a <code>SensorMetaType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SensorMetaType typedDst = (SensorMetaType) destination;
        SensorMetaType typedSrc = (SensorMetaType) source;
        ...
        Object sample) 
    {
        ...
        SensorMetaType typedSrc = (SensorMetaType) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.sensorName );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.updateFreq);

            dst.writeString(typedSrc.sensorName,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SensorMetaType typedDst = (SensorMetaType) dst;
            typedDst.clear();      
            try{
                typedDst.updateFreq = src.readInt();
                typedDst.sensorName = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SensorMetaType typedDst = (SensorMetaType) sample;
    ...
    int mask) {
        return new SensorMetaTypeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SensorMetaTypeDataReader(native_reader, listener, mask, this);   
    ...
    protected SensorMetaTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SensorMetaTypeTypeCode.VALUE,SensorMetaType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SensorMetaTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SensorMetaTypeTypeCode.VALUE,SensorMetaType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
