...
public class WeatherLocationTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "abstract::Weather::WeatherLocation";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.cps._abstract.DataModel.LocationTypeTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            hu.bme.mit.inf.cps._abstract.DataModel.LocationTypeTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
