...
public class WeatherTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "abstract::Weather::Weather";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WeatherTypeSupport _singleton
    = new WeatherTypeSupport();
    ...
    */
    public static WeatherTypeSupport get_instance() {
        return _singleton;
    }

    public static WeatherTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WeatherTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Weather</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Weather typedDst = (Weather) destination;
        Weather typedSrc = (Weather) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false,encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false,encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        Weather typedSrc = (Weather) sample;
        ...
        currentAlignment += hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Weather typedDst = (Weather) dst;
            typedDst.clear();      
            hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.inf.cps._abstract.DataModel.DataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Weather typedDst = (Weather) sample;
    ...
    int mask) {
        return new WeatherDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WeatherDataReader(native_reader, listener, mask, this);   
    ...
    protected WeatherTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WeatherTypeCode.VALUE,Weather.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WeatherTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WeatherTypeCode.VALUE,Weather.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
